...
public class Options
{
    ...
    public static readonly List<ServerOption> s_serverFlagContainers = new List<ServerOption> { (ServerOption)1,
                                                    (ServerOption)2, (ServerOption)3, 
                                                    (ServerOption)4, (ServerOption)5,
                                                    (ServerOption)13, (ServerOption)14, 
                                                    (ServerOption)15, (ServerOption)0x10, (ServerOption)0x11 };
    ...
    private bool GetOptionImpl(Option option, out object val)
    {
        ...
        else
        {
            ...
            //        ulong uLongOption = NetCache.Get().GetULongOption(option3);
            //        if ((uLongOption & num2) != 0L)
            //        {
    ...
    {
        int num = 1;// (int)(ServerOptionFlag.HAS_SEEN_TOURNAMENT * flag);
    ...
    public void SetULong(Option option, ulong val)
    {
        ...
        {
            //ulong num;
            //bool uLongOption = NetCache.Get().GetULongOption(option2, out num);
